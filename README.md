...
🔭 I’m currently enhancing the efficiency of my ETL workflows, particularly in data extraction and processing. In the [Web Scrape Workflow Repository](https://github.com/Hannah-Ajibola/Web-Scrape-Workflow-python.git), I successfully automated the collection of stock market prices using Python with scheduled API calls, seamlessly processing the data into an SQL server.
